# Benchmark: Binary tree with heavy ARC traffic
# Each node is a heap-allocated object with reference counting.
# LTP Spike/Ladder should elide many temporary rc_inc/rc_dec pairs.

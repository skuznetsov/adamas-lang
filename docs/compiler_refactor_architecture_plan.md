...
> Status: deferred reference, revised 2026-07-03.
> This is the original staged refactor plan (2026-04). Its Phases 0-5 were not
> executed; the 2026-06/07 bootstrap effort routes through
> `docs/compiler_architecture_sdd.md` instead. Revisit this plan after s3b.

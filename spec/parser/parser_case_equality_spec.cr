...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 50: === case equality operator (PRODUCTION-READY)" do
    ...
    it "parses case equality with type on left" do
      ...
      left = arena[Adamas::Compiler::Frontend.node_left(binary_node).not_nil!]
      Adamas::Compiler::Frontend.node_kind(left).should eq(Adamas::Compiler::Frontend::NodeKind::Identifier)
      String.new(Adamas::Compiler::Frontend.node_literal(left).not_nil!).should eq("String")

      # Right is value
      right = arena[Adamas::Compiler::Frontend.node_right(binary_node).not_nil!]
      Adamas::Compiler::Frontend.node_kind(right).should eq(Adamas::Compiler::Frontend::NodeKind::Identifier)
      String.new(Adamas::Compiler::Frontend.node_literal(right).not_nil!).should eq("value")
    end
    ...
    it "parses case equality in binary expression" do
      ...
      left = arena[Adamas::Compiler::Frontend.node_left(binary_node).not_nil!]
      Adamas::Compiler::Frontend.node_kind(left).should eq(Adamas::Compiler::Frontend::NodeKind::Binary)
      String.new(Adamas::Compiler::Frontend.node_operator(left).not_nil!).should eq("===")
    ...
    it "parses chained case equality" do
      ...
      left_grouping = arena[Adamas::Compiler::Frontend.node_left(outer_binary).not_nil!]
      Adamas::Compiler::Frontend.node_kind(left_grouping).should eq(Adamas::Compiler::Frontend::NodeKind::Grouping)

      # Right is grouping containing ===
      right_grouping = arena[Adamas::Compiler::Frontend.node_right(outer_binary).not_nil!]

...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 40: typeof (type introspection) (PRODUCTION-READY)" do
    it "parses typeof with single argument" do
      ...
      typeof_expr = Adamas::Compiler::Frontend.node_assign_value(assign_node).not_nil!
      typeof_node = arena[typeof_expr]
      Adamas::Compiler::Frontend.node_kind(typeof_node).should eq(Adamas::Compiler::Frontend::NodeKind::Typeof)

      # Check arguments
      args = Adamas::Compiler::Frontend.node_typeof_args(typeof_node).not_nil!
      ...
      Adamas::Compiler::Frontend.node_literal(arg_node).not_nil!.should eq("x".to_slice)
    end
    ...
    it "parses typeof with multiple arguments (union type)" do
      ...
      # First arg: number
      arg1 = arena[args[0]]
      Adamas::Compiler::Frontend.node_kind(arg1).should eq(Adamas::Compiler::Frontend::NodeKind::Number)

      # Second arg: string
      arg2 = arena[args[1]]
      Adamas::Compiler::Frontend.node_kind(arg2).should eq(Adamas::Compiler::Frontend::NodeKind::String)

      # Third arg: boolean
      arg3 = arena[args[2]]
      Adamas::Compiler::Frontend.node_kind(arg3).should eq(Adamas::Compiler::Frontend::NodeKind::Bool)
    end
    ...
    it "parses nested typeof" do
      ...
      assign_node = arena[program.roots[0]]
      outer_typeof_expr = Adamas::Compiler::Frontend.node_assign_value(assign_node).not_nil!
      outer_typeof = arena[outer_typeof_expr]

      Adamas::Compiler::Frontend.node_kind(outer_typeof).should eq(Adamas::Compiler::Frontend::NodeKind::Typeof)

      # Outer typeof has one argument
      outer_args = Adamas::Compiler::Frontend.node_typeof_args(outer_typeof).not_nil!
      outer_args.size.should eq(1)

      # That argument is also a typeof
      inner_typeof = arena[outer_args[0]]
      Adamas::Compiler::Frontend.node_kind(inner_typeof).should eq(Adamas::Compiler::Frontend::NodeKind::Typeof)

      # Inner typeof has one argument (number 1)
      inner_args = Adamas::Compiler::Frontend.node_typeof_args(inner_typeof).not_nil!
    ...
    it "parses typeof with complex union type" do
      ...
      Adamas::Compiler::Frontend.node_kind(arena[args[0]]).should eq(Adamas::Compiler::Frontend::NodeKind::Number)
      Adamas::Compiler::Frontend.node_kind(arena[args[1]]).should eq(Adamas::Compiler::Frontend::NodeKind::String)
      Adamas::Compiler::Frontend.node_kind(arena[args[2]]).should eq(Adamas::Compiler::Frontend::NodeKind::Number)
      Adamas::Compiler::Frontend.node_kind(arena[args[3]]).should eq(Adamas::Compiler::Frontend::NodeKind::Bool)
      Adamas::Compiler::Frontend.node_kind(arena[args[4]]).should eq(Adamas::Compiler::Frontend::NodeKind::Nil)
    end
  end
end

...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 98: out keyword (C bindings output parameter)" do
    it "parses out with identifier" do
      ...
      Adamas::Compiler::Frontend.node_kind(out_node).should eq(Adamas::Compiler::Frontend::NodeKind::Out)
      Adamas::Compiler::Frontend.node_out_identifier(out_node).should_not be_nil
      String.new(Adamas::Compiler::Frontend.node_out_identifier(out_node).not_nil!).should eq("result")
    end
    ...
    it "parses out in function call" do
      ...
      Adamas::Compiler::Frontend.node_kind(out_arg).should eq(Adamas::Compiler::Frontend::NodeKind::Out)
      Adamas::Compiler::Frontend.node_out_identifier(out_arg).should_not be_nil
      String.new(Adamas::Compiler::Frontend.node_out_identifier(out_arg).not_nil!).should eq("new_var")
    end
    ...
    it "parses multiple out parameters" do
      ...
      ["x", "y", "z"].each_with_index do |name, idx|
        ...
        Adamas::Compiler::Frontend.node_kind(out_arg).should eq(Adamas::Compiler::Frontend::NodeKind::Out)
        String.new(Adamas::Compiler::Frontend.node_out_identifier(out_arg).not_nil!).should eq(name)
      end
    end
    ...
    it "parses out with different identifier names" do
      ...
      Adamas::Compiler::Frontend.node_kind(out_node).should eq(Adamas::Compiler::Frontend::NodeKind::Out)
      String.new(Adamas::Compiler::Frontend.node_out_identifier(out_node).not_nil!).should eq("foo_bar_123")
    end
    ...
    it "parses out in lib context" do
      ...
      out_arg = arena[args[0]]
      Adamas::Compiler::Frontend.node_kind(out_arg).should eq(Adamas::Compiler::Frontend::NodeKind::Out)
      String.new(Adamas::Compiler::Frontend.node_out_identifier(out_arg).not_nil!).should eq("result")
    end
    ...
    it "parses out mixed with regular arguments" do
      ...
      arg0 = arena[args[0]]
      Adamas::Compiler::Frontend.node_kind(arg0).should eq(Adamas::Compiler::Frontend::NodeKind::Number)

      # Second arg: out status
      arg1 = arena[args[1]]
      Adamas::Compiler::Frontend.node_kind(arg1).should eq(Adamas::Compiler::Frontend::NodeKind::Out)
      String.new(Adamas::Compiler::Frontend.node_out_identifier(arg1).not_nil!).should eq("status")
      ...
      arg3 = arena[args[3]]
      Adamas::Compiler::Frontend.node_kind(arg3).should eq(Adamas::Compiler::Frontend::NodeKind::Out)
      String.new(Adamas::Compiler::Frontend.node_out_identifier(arg3).not_nil!).should eq("error_code")
    end
    ...
    it "parses out without identifier as an identifier (semantic error later)" do
      ...
      Adamas::Compiler::Frontend.node_kind(node).should eq(Adamas::Compiler::Frontend::NodeKind::Identifier)
    end

...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 69: Tuple literals {1, 2, 3} (DISCOVERED - Testing)" do
    it "parses simple tuple with multiple elements" do
      ...
      Adamas::Compiler::Frontend.node_kind(tuple).should eq(Adamas::Compiler::Frontend::NodeKind::TupleLiteral)

      elements = Adamas::Compiler::Frontend.node_tuple_elements(tuple).not_nil!
    ...
    it "parses nested tuples" do
      ...
      Adamas::Compiler::Frontend.node_kind(outer_tuple).should eq(Adamas::Compiler::Frontend::NodeKind::TupleLiteral)

      outer_elements = Adamas::Compiler::Frontend.node_tuple_elements(outer_tuple).not_nil!
      outer_elements.size.should eq(2)

      # Check first inner tuple
      inner1 = arena[outer_elements[0]]
      Adamas::Compiler::Frontend.node_kind(inner1).should eq(Adamas::Compiler::Frontend::NodeKind::TupleLiteral)

      # Check second inner tuple
      inner2 = arena[outer_elements[1]]
      Adamas::Compiler::Frontend.node_kind(inner2).should eq(Adamas::Compiler::Frontend::NodeKind::TupleLiteral)
    end
    ...
    it "parses tuple with expressions" do
      ...
      Adamas::Compiler::Frontend.node_kind(elem1).should eq(Adamas::Compiler::Frontend::NodeKind::Binary)
    end
    ...
    it "parses tuple in method call" do
      ...
      call_node.should be_a(Adamas::Compiler::Frontend::CallNode)

      args = call_node.as(Adamas::Compiler::Frontend::CallNode).args
      args.size.should eq(1)

      arg = arena[args[0]]
      Adamas::Compiler::Frontend.node_kind(arg).should eq(Adamas::Compiler::Frontend::NodeKind::TupleLiteral)
    end
    ...
    it "parses tuple in array literal" do
      ...
      Adamas::Compiler::Frontend.node_kind(elem1).should eq(Adamas::Compiler::Frontend::NodeKind::TupleLiteral)

      elem2 = arena[array_elements[1]]
      Adamas::Compiler::Frontend.node_kind(elem2).should eq(Adamas::Compiler::Frontend::NodeKind::TupleLiteral)
    end
    ...
    it "parses tuple with identifier elements" do
      ...
      elem1 = arena[elements[0]]
      Adamas::Compiler::Frontend.node_kind(elem1).should eq(Adamas::Compiler::Frontend::NodeKind::Identifier)
    end
  end
end

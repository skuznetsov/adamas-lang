...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 84: Spawn keyword (fiber concurrency)" do
    it "parses spawn do...end block form" do
      ...
      Adamas::Compiler::Frontend.node_kind(spawn_node).should eq(Adamas::Compiler::Frontend::NodeKind::Spawn)

      # Block form should have spawn_body
      body = Adamas::Compiler::Frontend.node_spawn_body(spawn_node).not_nil!
      body.size.should eq(1)

      # No spawn_expression in block form
      Adamas::Compiler::Frontend.node_spawn_expression(spawn_node).should be_nil
    end
    ...
    it "parses spawn expression form" do
      ...
      expr = Adamas::Compiler::Frontend.node_spawn_expression(spawn_node).not_nil!
      expr_node = arena[expr]
      Adamas::Compiler::Frontend.node_kind(expr_node).should eq(Adamas::Compiler::Frontend::NodeKind::Call)

      # No spawn_body in expression form
      Adamas::Compiler::Frontend.node_spawn_body(spawn_node).should be_nil
    end
    ...
    it "parses spawn with assignment result" do
      ...
      Adamas::Compiler::Frontend.node_kind(value).should eq(Adamas::Compiler::Frontend::NodeKind::Spawn)
    end
    ...
    it "parses nested spawn blocks" do
      ...
      Adamas::Compiler::Frontend.node_kind(outer_spawn).should eq(Adamas::Compiler::Frontend::NodeKind::Spawn)

      outer_body = Adamas::Compiler::Frontend.node_spawn_body(outer_spawn).not_nil!
      outer_body.size.should eq(2)

      # First statement should be inner spawn
      inner_spawn = arena[outer_body[0]]
      Adamas::Compiler::Frontend.node_kind(inner_spawn).should eq(Adamas::Compiler::Frontend::NodeKind::Spawn)
    end
    ...
    it "parses multiple spawn statements" do
      ...
      Adamas::Compiler::Frontend.node_kind(spawn1).should eq(Adamas::Compiler::Frontend::NodeKind::Spawn)

      spawn2 = arena[program.roots[1]]
      Adamas::Compiler::Frontend.node_kind(spawn2).should eq(Adamas::Compiler::Frontend::NodeKind::Spawn)

      spawn3 = arena[program.roots[2]]
      Adamas::Compiler::Frontend.node_kind(spawn3).should eq(Adamas::Compiler::Frontend::NodeKind::Spawn)
    end
  end
end

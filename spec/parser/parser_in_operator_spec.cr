...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 79: In operator (containment check)" do
    it "parses simple in expression" do
      ...
      Adamas::Compiler::Frontend.node_operator(binary).not_nil!.should eq("in".to_slice)
    end
    ...
    it "parses in with array literal" do
      ...
      Adamas::Compiler::Frontend.node_kind(right).should eq(Adamas::Compiler::Frontend::NodeKind::ArrayLiteral)
    end
    ...
    it "parses in with range" do
      ...
      right_grouping = arena[Adamas::Compiler::Frontend.node_right(binary).not_nil!]
      Adamas::Compiler::Frontend.node_kind(right_grouping).should eq(Adamas::Compiler::Frontend::NodeKind::Grouping)

      right = arena[Adamas::Compiler::Frontend.node_left(right_grouping).not_nil!]
      Adamas::Compiler::Frontend.node_kind(right).should eq(Adamas::Compiler::Frontend::NodeKind::Range)
    end
    ...
    it "parses in within if condition" do
      ...
      Adamas::Compiler::Frontend.node_operator(condition).not_nil!.should eq("in".to_slice)
    end
    ...
    it "parses negated in with not" do
      ...
      operand_grouping = arena[Adamas::Compiler::Frontend.node_right(unary).not_nil!]
      Adamas::Compiler::Frontend.node_kind(operand_grouping).should eq(Adamas::Compiler::Frontend::NodeKind::Grouping)

      operand = arena[Adamas::Compiler::Frontend.node_left(operand_grouping).not_nil!]
      Adamas::Compiler::Frontend.node_kind(operand).should eq(Adamas::Compiler::Frontend::NodeKind::Binary)
      Adamas::Compiler::Frontend.node_operator(operand).not_nil!.should eq("in".to_slice)
    end
    ...
    it "parses in in assignment" do
      ...
      Adamas::Compiler::Frontend.node_operator(value).not_nil!.should eq("in".to_slice)
    end
    ...
    it "parses in as method argument" do
      ...
      Adamas::Compiler::Frontend.node_operator(arg).not_nil!.should eq("in".to_slice)
    end
    ...
    it "parses in with complex left expression" do
      ...
      Adamas::Compiler::Frontend.node_kind(left).should eq(Adamas::Compiler::Frontend::NodeKind::MemberAccess)
    end
    ...
    it "parses multiple in expressions" do
      ...
      Adamas::Compiler::Frontend.node_operator(binary1).not_nil!.should eq("in".to_slice)

      binary2 = arena[program.roots[1]]
      Adamas::Compiler::Frontend.node_kind(binary2).should eq(Adamas::Compiler::Frontend::NodeKind::Binary)
      Adamas::Compiler::Frontend.node_operator(binary2).not_nil!.should eq("in".to_slice)
    end

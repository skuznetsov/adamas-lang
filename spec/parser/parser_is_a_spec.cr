...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 93: is_a? keyword (type check pseudo-method - returns Bool)" do
    it "parses simple type check" do
      ...
      is_a_node = arena[Adamas::Compiler::Frontend.node_assign_value(assign_node).not_nil!]
      Adamas::Compiler::Frontend.node_kind(is_a_node).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)

      # Check target type
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(is_a_node).not_nil!).should eq("Int32")

      # Check value being checked
      value_node = arena[Adamas::Compiler::Frontend.node_is_a_value(is_a_node).not_nil!]
    ...
    it "parses type check with complex expression" do
      ...
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(is_a_node).not_nil!).should eq("String")
    ...
    it "parses chained type checks" do
      ...
      assign_node = arena[program.roots[0]]
      outer_check = arena[Adamas::Compiler::Frontend.node_assign_value(assign_node).not_nil!]
      Adamas::Compiler::Frontend.node_kind(outer_check).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(outer_check).not_nil!).should eq("String")

      # Inner check
      inner_check = arena[Adamas::Compiler::Frontend.node_is_a_value(outer_check).not_nil!]
      Adamas::Compiler::Frontend.node_kind(inner_check).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(inner_check).not_nil!).should eq("Int32")
    end
    ...
    it "parses type check in method call arguments" do
      ...
      arg = arena[args[0]]
      Adamas::Compiler::Frontend.node_kind(arg).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(arg).not_nil!).should eq("Int32")
    end
    ...
    it "parses type check in array literal" do
      ...
      Adamas::Compiler::Frontend.node_kind(first).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(first).not_nil!).should eq("Int32")

      second = arena[elements[1]]
      Adamas::Compiler::Frontend.node_kind(second).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(second).not_nil!).should eq("String")
    end
    ...
    it "parses type check in conditional" do
      ...
      Adamas::Compiler::Frontend.node_kind(condition).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(condition).not_nil!).should eq("Int32")
    end
    ...
    it "parses type check with custom type" do
      ...
      Adamas::Compiler::Frontend.node_kind(is_a_node).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(is_a_node).not_nil!).should eq("MyClass")
    end
    ...
    it "parses type check in method definition" do
      ...
      Adamas::Compiler::Frontend.node_kind(body).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(body).not_nil!).should eq("Int32")
    end
    ...
    it "parses type check in class method" do
      ...
      Adamas::Compiler::Frontend.node_kind(def_body).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(def_body).not_nil!).should eq("String")
    end
    ...
    it "parses type check after method call" do
      ...
      receiver = arena[Adamas::Compiler::Frontend.node_is_a_value(is_a_node).not_nil!]
    ...
    it "parses type check in return statement" do
      ...
      Adamas::Compiler::Frontend.node_kind(return_value).should eq(Adamas::Compiler::Frontend::NodeKind::IsA)
      String.new(Adamas::Compiler::Frontend.node_is_a_target_type(return_value).not_nil!).should eq("String")
    end
  end
end

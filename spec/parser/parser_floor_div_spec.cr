...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 78: Floor division operator (//)" do
    ...
    it "parses floor division in expression" do
      ...
      Adamas::Compiler::Frontend.node_operator(value).not_nil!.should eq("//".to_slice)
    end
    ...
    it "distinguishes floor division from regular division" do
      ...
      left = arena[Adamas::Compiler::Frontend.node_left(binary1).not_nil!]
      Adamas::Compiler::Frontend.node_kind(left).should eq(Adamas::Compiler::Frontend::NodeKind::Binary)
      Adamas::Compiler::Frontend.node_operator(left).not_nil!.should eq("/".to_slice)
    end
    ...
    it "parses floor division with precedence" do
      ...
      Adamas::Compiler::Frontend.node_operator(right).not_nil!.should eq("//".to_slice)
    end
    ...
    it "parses floor division as method argument" do
      ...
      Adamas::Compiler::Frontend.node_operator(arg).not_nil!.should eq("//".to_slice)
    end
    ...
    it "parses floor division in array" do
      ...
      Adamas::Compiler::Frontend.node_operator(elem1).not_nil!.should eq("//".to_slice)
    end

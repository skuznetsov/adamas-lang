...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 80: Regex match operators (=~, !~)" do
    ...
    it "parses regex match with complex regex" do
      ...
      Adamas::Compiler::Frontend.node_kind(right).should eq(Adamas::Compiler::Frontend::NodeKind::Regex)
    end
    ...
    it "disambiguates =~ from = and =>" do
      ...
      Adamas::Compiler::Frontend.node_kind(assign3).should eq(Adamas::Compiler::Frontend::NodeKind::Assign)

      value = arena[Adamas::Compiler::Frontend.node_assign_value(assign3).not_nil!]
      Adamas::Compiler::Frontend.node_kind(value).should eq(Adamas::Compiler::Frontend::NodeKind::Binary)
      String.new(Adamas::Compiler::Frontend.node_operator(value).not_nil!).should eq("=~")
    end
  end

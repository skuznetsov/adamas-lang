...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 72: Named arguments at call site (PRODUCTION-READY)" do
    it "parses method call with single named argument" do
      ...
      named_args = call.as(Adamas::Compiler::Frontend::CallNode).named_args.not_nil!
    ...
    it "parses method call with only positional arguments" do
      ...
      call = arena[program.roots[0]]
      args = call.as(Adamas::Compiler::Frontend::CallNode).args.not_nil!
      args.size.should eq(2)
      call.as(Adamas::Compiler::Frontend::CallNode).named_args.should be_nil
    end
    ...
    it "parses empty method call" do
      ...
      call = arena[program.roots[0]]
      Adamas::Compiler::Frontend.node_kind(call).should eq(Adamas::Compiler::Frontend::NodeKind::Call)
      call.as(Adamas::Compiler::Frontend::CallNode).args.empty?.should be_true
      call.as(Adamas::Compiler::Frontend::CallNode).named_args.should be_nil
    end
    ...
    it "parses named arguments with string values" do
      ...
      value1 = arena[named_args[0].value]
      Adamas::Compiler::Frontend.node_kind(value1).should eq(Adamas::Compiler::Frontend::NodeKind::String)
    end
    ...
    it "parses member access with named arguments" do
      ...
      callee = arena[call.as(Adamas::Compiler::Frontend::CallNode).callee.not_nil!]
    ...
    it "parses named arguments with nil and boolean values" do
      ...
      value1 = arena[named_args[0].value]
      Adamas::Compiler::Frontend.node_kind(value1).should eq(Adamas::Compiler::Frontend::NodeKind::Bool)

      value2 = arena[named_args[1].value]
      Adamas::Compiler::Frontend.node_kind(value2).should eq(Adamas::Compiler::Frontend::NodeKind::Nil)
    end
    ...
    it "parses nested calls with named arguments" do
      ...
      Adamas::Compiler::Frontend.node_kind(outer_call).should eq(Adamas::Compiler::Frontend::NodeKind::Call)

      # outer has positional arg (inner call) and named arg
      outer_args = outer_call.as(Adamas::Compiler::Frontend::CallNode).args.not_nil!
      outer_args.size.should eq(1)

      inner_call = arena[outer_args[0]]
      Adamas::Compiler::Frontend.node_kind(inner_call).should eq(Adamas::Compiler::Frontend::NodeKind::Call)

      inner_named_args = inner_call.as(Adamas::Compiler::Frontend::CallNode).named_args.not_nil!
      inner_named_args.size.should eq(1)
      String.new(inner_named_args[0].name).should eq("x")

      outer_named_args = outer_call.as(Adamas::Compiler::Frontend::CallNode).named_args.not_nil!

...
describe Adamas::MIR do
  ...
  describe "Module" do
    it "creates functions" do
      ...
      func.return_type.should eq(Adamas::MIR::TypeRef::INT32)
    end

    it "looks up functions by name" do
      mod = Adamas::MIR::Module.new("test")
      mod.create_function("foo", Adamas::MIR::TypeRef::VOID)
  ...
  describe "Function" do
    ...
    it "computes predecessors" do
      ...
      # entry → then, else
      func.get_block(func.entry_block).terminator = Adamas::MIR::Branch.new(0_u32, then_block, else_block)

      # then → merge
      func.get_block(then_block).terminator = Adamas::MIR::Jump.new(merge_block)

      # else → merge
      func.get_block(else_block).terminator = Adamas::MIR::Jump.new(merge_block)

      # merge → return
      func.get_block(merge_block).terminator = Adamas::MIR::Return.new(nil)
  ...
  describe "Builder" do
    ...
    it "builds arithmetic operations" do
      ...
      diff = builder.sub(a, b, Adamas::MIR::TypeRef::INT32)
      prod = builder.mul(a, b, Adamas::MIR::TypeRef::INT32)
      ...
      # Verify types
      block.instructions[2].should be_a(Adamas::MIR::BinaryOp)
      (block.instructions[2].as(Adamas::MIR::BinaryOp)).op.should eq(Adamas::MIR::BinOp::Add)
    end
    ...
    it "builds comparisons" do
      ...
      a = builder.const_int(5, Adamas::MIR::TypeRef::INT32)
      b = builder.const_int(10, Adamas::MIR::TypeRef::INT32)
      ...
      block = func.get_block(func.entry_block)
      block.instructions[2].type.should eq(Adamas::MIR::TypeRef::BOOL)
      block.instructions[3].type.should eq(Adamas::MIR::TypeRef::BOOL)
    end
    ...
    it "builds memory operations" do
      ...
      # Stack allocation
      stack_ptr = builder.alloc(Adamas::MIR::MemoryStrategy::Stack, Adamas::MIR::TypeRef::INT32)
      ...
      # Load
      loaded = builder.load(stack_ptr, Adamas::MIR::TypeRef::INT32)
      ...
      alloc_inst = block.instructions[0].as(Adamas::MIR::Alloc)
      alloc_inst.strategy.should eq(Adamas::MIR::MemoryStrategy::Stack)
    end
    ...
    it "builds ARC operations" do
      ...
      block = func.get_block(func.entry_block)
      block.instructions[1].should be_a(Adamas::MIR::RCIncrement)
      block.instructions[2].should be_a(Adamas::MIR::RCDecrement)
    end
    ...
    it "builds atomic ARC operations" do
      ...
      ptr = builder.alloc(Adamas::MIR::MemoryStrategy::AtomicARC, Adamas::MIR::TypeRef.new(100_u32))
      ...
      block = func.get_block(func.entry_block)
      inc = block.instructions[1].as(Adamas::MIR::RCIncrement)
      dec = block.instructions[2].as(Adamas::MIR::RCDecrement)
    ...
    it "builds GEP for field access" do
      ...
      ptr = builder.alloc(Adamas::MIR::MemoryStrategy::Stack, Adamas::MIR::TypeRef.new(100_u32))

      # Access field at index 1
      field_ptr = builder.gep(ptr, [0_u32, 1_u32], Adamas::MIR::TypeRef::POINTER)

      field_ptr.should_not eq(ptr)

      gep = func.get_block(func.entry_block).instructions[1].as(Adamas::MIR::GetElementPtr)
  ...
  describe "Phi nodes" do
    it "builds phi with multiple incoming values" do
      ...
      phi.type.should eq(Adamas::MIR::TypeRef::INT32)

      # Phi should be first instruction in merge block
      merge = func.get_block(merge_block)
      merge.instructions[0].should be_a(Adamas::MIR::Phi)
    end
  end
  ...
  describe "Function calls" do
    it "builds direct calls" do
      ...
      # Create callee
      callee = mod.create_function("add", Adamas::MIR::TypeRef::INT32)
      callee.add_param("a", Adamas::MIR::TypeRef::INT32)
      callee.add_param("b", Adamas::MIR::TypeRef::INT32)

      # Create caller
      caller_func = mod.create_function("test", Adamas::MIR::TypeRef::INT32)
      builder = Adamas::MIR::Builder.new(caller_func)

      a = builder.const_int(10, Adamas::MIR::TypeRef::INT32)
      b = builder.const_int(20, Adamas::MIR::TypeRef::INT32)

      result = builder.call(callee.id, [a, b], Adamas::MIR::TypeRef::INT32)
      builder.ret(result)

      call_inst = caller_func.get_block(caller_func.entry_block).instructions[2].as(Adamas::MIR::Call)
    ...
    it "builds indirect calls" do
      ...
      func_ptr = builder.const_int(0, Adamas::MIR::TypeRef::POINTER)  # placeholder

      arg = builder.const_int(42, Adamas::MIR::TypeRef::INT32)
      result = builder.call_indirect(func_ptr, [arg], Adamas::MIR::TypeRef::VOID)

      builder.ret(nil)

      block = func.get_block(func.entry_block)
      block.instructions[2].should be_a(Adamas::MIR::IndirectCall)
    end
  end
  ...
  describe "Switch terminator" do
    it "builds switch with cases" do
      ...
      val = builder.const_int(1, Adamas::MIR::TypeRef::INT32)
      ...
      term = func.get_block(func.entry_block).terminator.as(Adamas::MIR::Switch)
  ...
  describe "text output" do
    it "prints function" do
      ...
      a = builder.const_int(0, Adamas::MIR::TypeRef::INT32)  # placeholder
      b = builder.const_int(0, Adamas::MIR::TypeRef::INT32)  # placeholder
      sum = builder.add(a, b, Adamas::MIR::TypeRef::INT32)
      builder.ret(sum)
  ...
  describe "Cast operations" do
    it "builds various casts" do
      ...
      i32_val = builder.const_int(42, Adamas::MIR::TypeRef::INT32)

      # Sign extend to i64
      i64_val = builder.cast(Adamas::MIR::CastKind::SExt, i32_val, Adamas::MIR::TypeRef::INT64)

      # Convert to float
      f64_val = builder.cast(Adamas::MIR::CastKind::SIToFP, i32_val, Adamas::MIR::TypeRef::FLOAT64)

      builder.ret(nil)

      block = func.get_block(func.entry_block)
      block.instructions[1].as(Adamas::MIR::Cast).kind.should eq(Adamas::MIR::CastKind::SExt)
      block.instructions[2].as(Adamas::MIR::Cast).kind.should eq(Adamas::MIR::CastKind::SIToFP)
    end
  end
  ...
  describe "Select instruction" do
    it "builds select (ternary)" do
      mod = Adamas::MIR::Module.new
      func = mod.create_function("max", Adamas::MIR::TypeRef::INT32)
      builder = Adamas::MIR::Builder.new(func)
      ...
      result = builder.select(cond, a, b, Adamas::MIR::TypeRef::INT32)
      builder.ret(result)

      select_inst = func.get_block(func.entry_block).instructions[3].as(Adamas::MIR::Select)
  ...
  describe "operands" do
    it "returns correct operands for each instruction type" do
      ...
      a = builder.const_int(1, Adamas::MIR::TypeRef::INT32)
      b = builder.const_int(2, Adamas::MIR::TypeRef::INT32)

      sum = builder.add(a, b, Adamas::MIR::TypeRef::INT32)
      neg = builder.neg(a, Adamas::MIR::TypeRef::INT32)

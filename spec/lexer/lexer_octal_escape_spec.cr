...
describe "Adamas::Compiler::Frontend::Parser" do
  describe "Phase 62: Octal escape sequences (PRODUCTION-READY)" do
    ...
    it "parses \\NNN octal in string (three digits)" do
      ...
      assign = arena[program.roots[0]]
      string_node = arena[Adamas::Compiler::Frontend.node_assign_value(assign).not_nil!]
      String.new(Adamas::Compiler::Frontend.node_literal(string_node).not_nil!).should eq("B")
    end
    ...
    it "parses mixed hex and octal escapes" do
      ...
      assign = arena[program.roots[0]]
      string_node = arena[Adamas::Compiler::Frontend.node_assign_value(assign).not_nil!]
      String.new(Adamas::Compiler::Frontend.node_literal(string_node).not_nil!).should eq("AA")
    end
  end
end

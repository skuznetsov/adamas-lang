...
describe Adamas::Compiler::Semantic::CompileShadowParseDiagnosticParity do
  it "counts missing and extra parse diagnostics by signature" do
    compile_diagnostics = [
      Adamas::Compiler::Frontend::Diagnostic.new(
        "unexpected RParen",
        Adamas::Compiler::Frontend::Span.new(0, 0, 1, 1, 1, 1),
        file_path: "main.cr",
      ),
      Adamas::Compiler::Frontend::Diagnostic.new(
        "unexpected RParen",
    ...
    shadow_diagnostics = [
      ...
      Adamas::Compiler::Frontend::Diagnostic.new(
        "unexpected token",
        Adamas::Compiler::Frontend::Span.new(2, 4, 2, 1, 2, 3),
        file_path: "main.cr",
      ),
    ]

    parity = Adamas::Compiler::Semantic::CompileShadowParseDiagnosticParity.compare(
      compile_diagnostics,
      shadow_diagnostics
    )
  ...
  it "builds a strict-mode message only when gaps exist" do
    ...
    shadow_diagnostics = [] of Adamas::Compiler::Frontend::Diagnostic
    ...
    matching = Adamas::Compiler::Semantic::CompileShadowParseDiagnosticParity.compare(
      compile_diagnostics,
      compile_diagnostics
    )

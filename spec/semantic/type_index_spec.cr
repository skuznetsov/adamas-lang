...
describe Adamas::Compiler::Semantic::TypeIndex do
  describe "TypeArena" do
    it "starts with 8 primitive types" do
      index = Adamas::Compiler::Semantic::TypeIndex.new
      index.arena.size.should eq 8
    end

    it "interns duplicate types to same TypeId" do
      arena = Adamas::Compiler::Semantic::TypeArena.new
      t1 = Adamas::Compiler::Semantic::PrimitiveType.new("MyType")
      t2 = Adamas::Compiler::Semantic::PrimitiveType.new("MyType")
      id1 = arena.intern(t1)
      id2 = arena.intern(t2)
    ...
    it "returns different TypeIds for different types" do
      arena = Adamas::Compiler::Semantic::TypeArena.new
      t1 = Adamas::Compiler::Semantic::PrimitiveType.new("TypeA")
      t2 = Adamas::Compiler::Semantic::PrimitiveType.new("TypeB")
      id1 = arena.intern(t1)
      id2 = arena.intern(t2)
    ...
    it "provides O(1) lookup by TypeId" do
      arena = Adamas::Compiler::Semantic::TypeArena.new
      t1 = Adamas::Compiler::Semantic::PrimitiveType.new("TestType")
      id = arena.intern(t1)
  ...
  describe "Serialization" do
    it "round-trips types through binary serialization" do
      ...
      # Add custom type
      custom = Adamas::Compiler::Semantic::PrimitiveType.new("CustomType")
      ...
      loaded = Adamas::Compiler::Semantic::TypeIndex.read(io)
  ...
  describe "TypeId" do
    it "distinguishes valid and invalid TypeIds" do
      valid = Adamas::Compiler::Semantic::TypeId.new(5)
      invalid = Adamas::Compiler::Semantic::TypeId::INVALID
  ...
  describe "Interning primitives" do
    it "returns same TypeId for same primitive name" do
      arena = Adamas::Compiler::Semantic::TypeArena.new
      ptype = Adamas::Compiler::Semantic::PrimitiveType.new("Int32")

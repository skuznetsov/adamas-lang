...
if type.is_a?(Adamas::Compiler::Semantic::PrimitiveType)
...
puts "\nBinary node operator: #{Adamas::Compiler::Frontend.node_operator_string(binary_node)}"

left_id = Adamas::Compiler::Frontend.node_left(binary_node)
right_id = Adamas::Compiler::Frontend.node_right(binary_node)
...
if left_id
  ...
  if left_type.is_a?(Adamas::Compiler::Semantic::PrimitiveType)
...
if right_id
  ...
  if right_type.is_a?(Adamas::Compiler::Semantic::PrimitiveType)

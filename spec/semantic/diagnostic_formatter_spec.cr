...
describe Adamas::Compiler::Semantic::DiagnosticFormatter do
  it "formats error with single-line primary span" do
      ...
      diagnostic = Adamas::Compiler::Semantic::Diagnostic.new(
        Adamas::Compiler::Semantic::DiagnosticLevel::Error,
        "E2001",
        "undefined local variable or method 'foo'",
        Adamas::Compiler::Frontend::Span.new(4, 7, 1, 5, 1, 8)  # start_offset, end_offset, start_line, start_column, end_line, end_column
      )

      output = Adamas::Compiler::Semantic::DiagnosticFormatter.format(source, diagnostic)
    ...
    it "formats warning with primary and secondary spans" do
      ...
      primary = Adamas::Compiler::Frontend::Span.new(0, 0, 3, 5, 3, 8)     # 'name' on line 3
      secondary = Adamas::Compiler::Frontend::Span.new(0, 0, 1, 3, 1, 6)  # 'name' on line 1

      diagnostic = Adamas::Compiler::Semantic::Diagnostic.new(
        Adamas::Compiler::Semantic::DiagnosticLevel::Warning,
        "W2001",
        "variable 'name' shadows outer scope variable",
        primary,
        [Adamas::Compiler::Semantic::SecondarySpan.new(secondary, "outer scope definition here")]
      )
    ...
    it "formats error with duplicate definition (two secondary spans)" do
      ...
      primary = Adamas::Compiler::Frontend::Span.new(0, 0, 5, 7, 5, 9)

      # Secondary 1: first 'bar' definition
      sec1 = Adamas::Compiler::Frontend::Span.new(0, 0, 2, 7, 2, 9)

      # Secondary 2: class Foo context
      sec2 = Adamas::Compiler::Frontend::Span.new(0, 0, 4, 1, 4, 9)
      ...
      diagnostic = Adamas::Compiler::Semantic::Diagnostic.new(
        ...
        primary,
        [
          Adamas::Compiler::Semantic::SecondarySpan.new(sec1, "previous definition here"),
          Adamas::Compiler::Semantic::SecondarySpan.new(sec2, "in reopened class 'Foo'"),
        ]
      )
    ...
    it "formats diagnostic without source (location only)" do
      diagnostic = Adamas::Compiler::Semantic::Diagnostic.new(
        Adamas::Compiler::Semantic::DiagnosticLevel::Info,
        "I1001",
        "informational message",
        Adamas::Compiler::Frontend::Span.new(0, 0, 10, 5, 10, 10)
      )

      output = Adamas::Compiler::Semantic::DiagnosticFormatter.format(nil, diagnostic)
    ...
    it "handles multi-line spans" do
      ...
      diagnostic = Adamas::Compiler::Semantic::Diagnostic.new(
        ...
        Adamas::Compiler::Frontend::Span.new(0, 0, 1, 1, 4, 1)
      )
    ...
    it "formats file-aware diagnostics from a source map" do
      ...
      diagnostic = Adamas::Compiler::Semantic::Diagnostic.new(
        ...
        Adamas::Compiler::Frontend::Span.new(0, 3, 1, 1, 1, 4),
        [
          Adamas::Compiler::Semantic::SecondarySpan.new(
            Adamas::Compiler::Frontend::Span.new(0, 5, 1, 1, 1, 6),
      ...
      output = Adamas::Compiler::Semantic::DiagnosticFormatter.format(sources, diagnostic)
